---
layout: post
title: "#06 MEGAGEN 임플란트 모니터링 시스템(반응형)"
summary: 공작기계 데이터 모니터링 시스템(반응형) 구현
featured-img: card_megagen
comments: false
categories: []
---

<img src="../assets/img/posts/megagen02.jpeg" width="450px" height="300px" title="HomepageWeb"/><br/>

# MEGAGEN 임플란트 모니터링 시스템

- 회사명/직책 : UNOMIC / 연구원
- 기간 : 202105 ~ 202110 (5개월)
- 사용언어 : VueJs, Scss
- 성과 : 공작기계의 가동률 및 생산수량, 효율성 등을 보여주는 모니터링 시스템을 구현함으로써 작업 효율성을 높일수 있도록 하였습니다.
- 역할 : 웹 프로토타입, Front-End 작업
