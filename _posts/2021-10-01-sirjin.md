...
layout: post
title: "#스마트팩토리(서진산업)"
summary: 설비 데이터 관리 & 모니터링 시스템 구현
featured-img: card_sirjin
comments: false
categories: []
---

<img src="../assets/img/posts/sirjin01.jpeg" width="450px" height="300px" title="HomepageWeb" /><br/>
...
- ### 주요 업무 : 1. 공작기계의 가동률 및 생산수량, 효율성 등을 보여주는 모니터링 시스템을 구현<br>
  ...
  ### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. I18n 을 활용한 다국어 사용<br>
- ### 투입 인원 : 4명<br>
- ### 역할 : Front-End

<img src="../assets/img/posts/sirjin_list.jpeg" width="450px" title="HomepageWeb"/><br/>
