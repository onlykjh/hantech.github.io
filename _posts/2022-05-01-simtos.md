---
layout: post
title: "#실시간 설비 모니터링(SIMTOS)"
summary: 실시간 3D 프린트 상태 & 데이터 확인
featured-img: card_simtos
comments: false
categories: []
---

<img src="../assets/img/posts/simtos01.jpeg" width="450px" height="300px" title="HomepageWeb" /><br/>

<!-- # 승명실업 생산 관리 시스템 구현 -->

- ### 회사명/직책 : UNOMIC / 연구원
- ### 주요 업무 : 1. Swagger 를 사용하여 API 개발 & 문서 자동화 
###  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. MSSQL 프로시저 개발 및 수정
###  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. 데이터 관리
- ### 투입 인원 : 5명
- ### 역할 : Back-End

<img src="../assets/img/posts/simtos_list.jpeg" width="450px" title="HomepageWeb"/><br/>
